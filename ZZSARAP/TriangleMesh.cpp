...
void TriangleMesh::GetVertex( VertexID vID, Vector3f & vVertex, Vector3f * pNormal ) const 
{
...
unsigned int
TriangleMesh::AppendVertexData( const Vector3f * pVertex, const Wml::Vector3f * pNormal, 
